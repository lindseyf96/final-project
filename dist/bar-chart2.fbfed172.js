...
},{"d3-collection":"../../../../../../node_modules/d3-collection/src/index.js","d3-selection":"../../../../../../node_modules/d3-selection/src/index.js"}],"data/hate-crimes-religion.csv":[function(require,module,exports) {
module.exports = "/hate-crimes-religion.7b20a24f.csv";
},{}],"scripts/bar-chart2.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#bar-chart2').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Build your scales here

var xPositionScale = d3.scaleLinear().domain([0, 220]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['New York City', 'Los Angeles', 'Seattle', 'Phoenix', 'Boston']).range([0, height]).padding(0.25);
var y_axis = d3.axisLeft(yPositionScale);
svg.append('g').attr('class', 'axis y-axis').call(y_axis).attr('font-size', 18);
d3.csv(require('../data/hate-crimes-religion.csv')).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../../../../../../node_modules/d3-tip/index.js","../data/hate-crimes-religion.csv":"data/hate-crimes-religion.csv"}]},{},["scripts/bar-chart2.js"], null)
//# sourceMappingURL=/bar-chart2.fbfed172.js.map