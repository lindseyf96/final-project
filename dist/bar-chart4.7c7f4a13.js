...
},{"d3-collection":"../../../../../node_modules/d3-collection/src/index.js","d3-selection":"../../../../../node_modules/d3-selection/src/index.js"}],"data/hate-crimes-disability.csv":[function(require,module,exports) {
module.exports = "/hate-crimes-disability.b9dfb61e.csv";
},{}],"scripts/bar-chart4.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#bar-chart4').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Build your scales here

var xPositionScale = d3.scaleLinear().domain([0, 5]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['Detriot', 'Cleveland', 'Columbus', 'Seattle', 'Madison, OH']).range([0, height]).padding(0.25);
var y_axis = d3.axisLeft(yPositionScale);
svg.append('g').attr('class', 'axis y-axis').call(y_axis).attr('font-size', 18);
d3.csv(require('../data/hate-crimes-disability.csv')).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../../../../../node_modules/d3-tip/index.js","../data/hate-crimes-disability.csv":"data/hate-crimes-disability.csv"}]},{},["scripts/bar-chart4.js"], null)
//# sourceMappingURL=/bar-chart4.7c7f4a13.js.map