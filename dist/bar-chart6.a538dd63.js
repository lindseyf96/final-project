...
},{"d3-collection":"../../../../../node_modules/d3-collection/src/index.js","d3-selection":"../../../../../node_modules/d3-selection/src/index.js"}],"data/hate-crimes-genderidentity.csv":[function(require,module,exports) {
module.exports = "/hate-crimes-genderidentity.ac935a59.csv";
},{}],"scripts/bar-chart6.js":[function(require,module,exports) {
"use strict";
...
var width = 219 - margin.left - margin.right;
var svg = d3.select('#bar-chart6').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Build your scales here

var xPositionScale = d3.scaleLinear().domain([0, 35]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['D.C.', 'Seattle', 'New York City', 'Los Angeles', 'Eugene, OR']).range([0, height]).padding(0.25);
var y_axis = d3.axisLeft(yPositionScale);
svg.append('g').attr('class', 'axis y-axis').call(y_axis).attr('font-size', 18);
d3.csv(require('../data/hate-crimes-genderidentity.csv')).then(ready).catch(function (err) {
  console.log('Failed with', err);
});
var tip = d3.tip().attr('class', 'd3-tip').offset([0, 10]).html(function (d) {
  return " <span style='color:white'>".concat(d.number, "</span>");
}).direction('e');
svg.call(tip); // const x_axis = d3.axisBottom(xPositionScale)
// svg
//   .append('g')
...
function ready(datapoints) {
  ...
  var x_axis = d3.axisTop(xPositionScale).ticks(3) // .tickFormat(d => d + '%')
  .tickSize(-height);
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../../../../../node_modules/d3-tip/index.js","../data/hate-crimes-genderidentity.csv":"data/hate-crimes-genderidentity.csv"}]},{},["scripts/bar-chart6.js"], null)
//# sourceMappingURL=/bar-chart6.a538dd63.js.map