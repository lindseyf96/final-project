...
},{"d3-collection":"../../../../../../node_modules/d3-collection/src/index.js","d3-selection":"../../../../../../node_modules/d3-selection/src/index.js"}],"data/hate-crimes-gender.csv":[function(require,module,exports) {
module.exports = "/hate-crimes-gender.ce39dab5.csv";
},{}],"scripts/bar-chart5.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#bar-chart5').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Build your scales here

var xPositionScale = d3.scaleLinear().domain([0, 3]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['Seattle', 'Highland Park, MI', 'Indianapolis', 'Fowlerville, MI', 'Detriot']).range([0, height]).padding(0.25);
var y_axis = d3.axisLeft(yPositionScale);
svg.append('g').attr('class', 'axis y-axis').call(y_axis).attr('font-size', 18);
d3.csv(require('../data/hate-crimes-gender.csv')).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../../../../../../node_modules/d3-tip/index.js","../data/hate-crimes-gender.csv":"data/hate-crimes-gender.csv"}]},{},["scripts/bar-chart5.js"], null)
//# sourceMappingURL=/bar-chart5.cc7595a8.js.map