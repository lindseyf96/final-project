...
var images = d3.selectAll('.image-stepper img');
images.style('display', 'none');
/* Show the first one */

d3.select('.image-stepper img:first-child').style('display', 'block');
d3.selectAll('.image-stepper .step').each(function (d) {
...
d3.selectAll('.image-stepper .step').on('stepin', function () {
  // Hide all the images
  images.style('display', 'none'); // Show one of the images

  var imageId = d3.select(this).attr('data-show-selector');
  d3.selectAll(imageId).style('display', 'block');
});
},{"d3":"../node_modules/d3/index.js"}]},{},["scripts/hate-symbols.js"], null)
//# sourceMappingURL=/hate-symbols.3e9a739c.js.map